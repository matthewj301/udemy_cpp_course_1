...
void Trust_Account::print(std::ostream &os) const {
    os << "Type: Trust Account, Name: " << name << ", balance: " << balance << ", interest rate: " << int_rate
    << ", Bonus Threshold: " << bonus_threshold << ", Max Withdrawals: " << max_withdrawals << ", Current Withdrawals: "
    << num_withdrawals << std::endl;
}
