...
int main() {
    ...
    do {
        ...
        if (_tolower(selection) == 'p') {
            cout << "Current numbers: [ ";
            for (auto number: numbers) {
                cout << number << " ";
            }
            cout << ']' << endl;
        } else if (_tolower(selection) == 'a') {
            cout << "Enter a number to add: ";
            int number_to_add{};
            cin >> number_to_add;
            numbers.push_back(number_to_add);
        } else if (_tolower(selection) == 'm') {
            if (numbers.size() == 0) {
